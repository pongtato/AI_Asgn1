...
CSceneManagerMenu::CSceneManagerMenu()
	: m_cMinimap(NULL)
	, m_cMap(NULL)
	, tileOffset_x(0)
	, tileOffset_y(0)
...
void CSceneManagerMenu::Update(double dt)
{
 ...
 ********************************************************************************/
void CSceneManagerMenu::UpdateCameraStatus(const unsigned char key, const bool status)
{
 ...
 ********************************************************************************/
void CSceneManagerMenu::UpdateWeaponStatus(const unsigned char key)
{
	if (key == WA_FIRE)
	{
 ...
 ********************************************************************************/
void CSceneManagerMenu::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
...
/********************************************************************************
 Render 2D Mesh
 ********************************************************************************/
void CSceneManagerMenu::Render2DMesh(Mesh *mesh, bool enableLight, int size, int x, int y, bool rotate, bool flip)
{
	Mtx44 ortho;
	ortho.SetToOrtho(0, 800, 0, 600, -10, 10);
	projectionStack.PushMatrix();
 ...
 ********************************************************************************/
void CSceneManagerMenu::RenderBackground()
{
...
void CSceneManagerMenu::Render()
{
	...
	RenderBackground();
	RenderTextOnScreen(meshList[GEO_TEXT], "Menu Screen", Color(0, 1, 0), 30, 50, 50);
 ...
 ********************************************************************************/
void CSceneManagerMenu::RenderTileMap()
{
	int m = 0;
 ...
 ********************************************************************************/
void CSceneManagerMenu::RenderRearTileMap()
{
 ...
 ********************************************************************************/
void CSceneManagerMenu::RenderGoodies()
{
	// Render the goodies
	for (int i=0; i<10; i++)
	{
